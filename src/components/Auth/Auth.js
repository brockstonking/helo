            ...
            <div className='authPage'>
                ...
                <div className='loginRegisterBox'>
                    ...
                    <div className='buttonDiv'>
                        <button className='buttons loginButton' onClick={ this.login }>Login</button>
                        <button className='buttons registerButton' onClick={ this.register }>Register</button>
                    </div>
                </div>
            </div>
        )
