...
class Nav extends Component {
    ...
    authMe(){
        ...
        .then( results => {
            const { username, profile_picture } = results.data[0]
            this.props.whichUserIsIt(username, profile_picture)
        })
    }
